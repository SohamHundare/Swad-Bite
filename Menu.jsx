      ...
      <div className="subscription-section">
        ...
        <div className="subscription-grid">
          <div className="subscription-card basic">
            ...
            <button onClick={() => window.location.href = '/payment/basic'}>Subscribe</button>
          </div>
          ...
          <div className="subscription-card standard">
            ...
            <button onClick={() => window.location.href = '/payment/standard'}>Subscribe</button>
          </div>
          ...
          <div className="subscription-card premium">
            ...
            <button onClick={() => window.location.href = '/payment/premium'}>Subscribe</button>
          </div>
        </div>
      </div>
    </div>
